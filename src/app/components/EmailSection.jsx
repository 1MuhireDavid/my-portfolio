      ...
      <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-8 items-center">
        ...
        <div className="z-10">
          ...
          <p className="text-gray-400 leading-relaxed mb-6">
            ...
            you have a project in mind, need advice, or just want to say hi,
            feel free to drop me a message. I’ll get back to you as soon as I
            can!
          </p>
          ...
          <div className="flex gap-6 mt-4 justify-center">
            ...
            >
              <div className="flex items-center justify-center p-3 bg-[#18191E] hover:bg-purple-500 rounded-full transition duration-300 cursor-pointer">
                <svg
